  ...
  return (
    <div className="fixed inset-0 z-dialog flex items-center justify-center bg-black/35 p-4">
      <motion.div
        ...
        className="w-full max-w-md rounded-lg border border-border bg-surface p-6 shadow-dialog"
      >
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="text-sm text-text-muted">Creas tu primer hábito ahora mismo</span>
              </button>
              <button
                type="button"
                onClick={chooseDemo}
