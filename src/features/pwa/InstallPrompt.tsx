  ...
  if (installed) {
    return (
      <Card className="p-4">
        ...
        <p className="text-xs text-text-faint">Nextuss ya está instalado como app.</p>
      </Card>
    )
  }
  ...
  return (
    <Card className="p-4">
      ...
      <p className="mb-3 text-xs text-text-faint">
        Instala Nextuss como app para abrirlo desde tu escritorio o pantalla de inicio, sin la barra del navegador.
      </p>
      <Button variant="secondary" onClick={promptInstall}>
        <Download size={14} strokeWidth={1.75} /> Instalar Nextuss
      </Button>
    </Card>
  )
}
